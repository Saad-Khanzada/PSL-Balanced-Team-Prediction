...
bowlingFeatures = bowling.drop(columns=['Best Bowling In An Innings', 'Four Wickets In An Innings', 
'Five Wickets In An Innings', '200+ Wickets Taken', '<35.00 Bowling Avg', '<4.00 Economy Rate', '<40.00 Bowling Strike Rate' ])
